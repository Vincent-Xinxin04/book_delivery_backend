...
class Permission(models.Model):
    Perm_ID = models.CharField(max_length=50, primary_key=True)
...
class Book(models.Model):
    ...
    book_author = models.CharField(max_length=50, unique=True)
    ...
    category = models.CharField(max_length=50, unique=True,default='NULL')    #分为多少类
